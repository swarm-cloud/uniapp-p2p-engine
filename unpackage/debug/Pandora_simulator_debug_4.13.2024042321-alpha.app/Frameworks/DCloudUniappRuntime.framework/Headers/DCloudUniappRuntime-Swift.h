...
+ (NSArray<NSString *> * _Nonnull)getExtApiProviders:(NSString * _Nonnull)service SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (float)getContentWidth:(BOOL)round SWIFT_WARN_UNUSED_RESULT;
- (float)getContentHeight:(BOOL)round SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP19DCloudUniappRuntime17UniExtApiProvider_")
@protocol UniExtApiProvider
@end


SWIFT_CLASS_NAMED("UniExtApiProviderManager")
@interface UniExtApiProviderManager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) UniExtApiProviderManager * _Nonnull shared;)
+ (UniExtApiProviderManager * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)registerExtApiProviderWithService:(NSString * _Nonnull)service providerName:(NSString * _Nonnull)providerName provider:(id <UniExtApiProvider> _Nonnull)provider;
- (NSArray<NSString *> * _Nonnull)getExtApiProviders:(NSString * _Nonnull)service SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
